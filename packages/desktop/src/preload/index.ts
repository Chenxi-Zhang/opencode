...
const api: ElectronAPI = {
  ...
  getNativeServerBinary: () => ipcRenderer.invoke("get-native-server-binary"),
  pickNativeServerBinary: () => ipcRenderer.invoke("pick-native-server-binary"),
  setNativeServerBinary: (path) => ipcRenderer.invoke("set-native-server-binary", path),
